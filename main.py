...
root.iconbitmap(f"{cwd}\\typewrite.ico")
...
image1=PhotoImage(file=f"{cwd}\\one.png")
image2=PhotoImage(file=f"{cwd}\\Slide15.png")
image3=PhotoImage(file=f"{cwd}\\Tricky-Words.png")
image4=PhotoImage(file=f"{cwd}\\words.png")

img_list=[image1,image2,image3,image4]

img_label=Label(frame3,image=image1,width=900,height=320)
img_label.pack()
